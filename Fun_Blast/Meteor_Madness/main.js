...
class Meteor {
  constructor( x, y, vx, vy, r, c, lL ) {
    ...
    for (let n = 1; n <= this.fragmentQuantity; n++) {
      this["fragment" + n] = {
        x: this.x, vx: 0, y: this.y, vy: 0, r: this.r / 2.25
      }
    }
  }
  draw() {
...
function mmStart() {
  document.getElementById("mm-main").style.display = "none"
  document.getElementById("mm-loading").style.display = "flex"
  document.getElementById("mm-loader").style.animation = "load 3s forwards"
...
document.getElementById("mm-start-btn").onclick = () => { mmStart() }
document.getElementById("mm-fullscreen-btn").onclick = () => { 
  document.getElementById("mm-slide").requestFullscreen()
  document.getElementById("mm-slide").style.border = "0px 25rem 0px 25rem"
  mmStart()
}


document.getElementById("mm-restart-btn").onclick = () => {
...
function main() {
  ...
  if (alive == false) {
    ...
    setTimeout(() => {
      document.getElementById("mm-over").style.display = "flex"
